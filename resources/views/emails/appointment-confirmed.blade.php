...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background: #dcfce7; color: #166534; padding: 4px 10px; border-radius: 99px; font-size: 11px; font-weight: 600; margin-bottom: 20px; }
    </style>
</head>
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p style="margin: 0 0 24px; color: #3f3f46;">
                Hi {{ $appointment->client->name }}, your appointment has been confirmed. Here are the details:
            </p>
        ...
        <div class="footer">
            This is an automated message from Appointment System. Please do not reply to this email.
        </div>
    </div>
</body>
</html>